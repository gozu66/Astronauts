...
public class PlayerMove : MonoBehaviour 
{
	...
	public float mouseSensitivity = 1.0f, jumpForce, maxVelocity;
	float V, H;
	...
	{	
		myRbody.velocity = Vector3.ClampMagnitude(myRbody.velocity, maxVelocity);					//CLAMP MAX VELOCITY 
		...
		if(playerIsMoving && myRbody.velocity != Vector3.zero)
		{
